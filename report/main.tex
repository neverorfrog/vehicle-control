...
\subsection{Comparison on a simple track}
...
\begin{table}[h] 
    ...
    \begin{tabular}{|c||c|c|c|c|c|}
        ...
        \hline
        Singletrack $V_{max}=20m/s$ & $-$ & $-$ & $82 ms$ & $13.83 m/s$ & $3232.29 N$\\
        \hline
    \end{tabular}
\end{table}
...
there should be higher speed. Actyally, the cascaded model can optimize in
a better way its velocity and the distribution of the force along the track, due
...
excessive braking in order to recover the track path.
...
\subsection{Playing with some parameters}
