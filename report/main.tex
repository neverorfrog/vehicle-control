...
The key element of the NLP is the cost function, which can be composed by many terms according to own puproses.
...
\begin{enumerate}
    \item \textbf{Final time}: the time at which the point-mass model reaches the last stage of the planning horizon
...
The constraints of the NLP regard some limitations on the states of the single-track and of the point-mass models, 
...
\begin{enumerate}
    ...
    spatial dynamics of the system explained in \ref{}
