...
class EulerIntegrator():
    ...
    def __init__(self, state: ca.MX, action: ca.MX, curvature: ca.MX, f: ca.MX, h: ca.MX):
        ...
        self.discrete_ode = ca.Function('f_discrete', [state, action, curvature, h], [x_next]).expand()
...
class RK4Integrator():
    ...
    def __init__(self, state: ca.MX, action: ca.MX, curvature: ca.MX, f: ca.MX, h: ca.MX):
        ...
        self.discrete_ode = ca.Function('f_discrete', [state, action, curvature, h], [state_next]).expand()
